...
var variables = _objectSpread(
  ...
  {},
  {
    ...
    button: _objectSpread(
      _objectSpread({}, commonTheme.button),
      {},
      {
        sm: {
          p: "4px 10px",
    ...
    modal: _objectSpread(
      _objectSpread({}, commonTheme.modal),
      {},
      {
...
function getFieldColorStyles(props) {
  if (props.dark) return "";
    ...
    return "\n    color: "
      .concat(getColor(props, "text"), ";\n    background-color: ")
      .concat(getColor(props, "background"), ";\n    border: 1px solid ")
      .concat(
        getColor(props, "border"),
        ";\n\n    &::-webkit-input-placeholder {\n      color:  "
      )
      .concat(
        getColor(props, "text", "muted"),
        ";\n    }\n    &::-moz-placeholder {\n      color:  "
      )
      .concat(
        getColor(props, "text", "muted"),
      ...
      .concat(getColor(props, "text"), ";\n      background-color: ")
      .concat(getColor(props, "background"), ";\n      border-color: ")
      .concat(getColor(props, "link"), ";\n      outline: 0;\n    }\n  ");
}

function getIconStyles(props) {
  return "\n    font-family: 'filerobot-image-editor-font' !important;\n    color: "
    .concat(
      props.muted ? props.theme.colors.textMute : props.theme.colors.text,
...
function isHex(color) {
  return (
    /^#?([a-f\d])([a-f\d])([a-f\d])$/i.test(color) ||
...
var getHoverColor = function getHoverColor(color) {
  ...
  return nextColor.toLowerCase() === color.toLowerCase()
    ? shadeBlendConvert(0.25, color)
    : nextColor;
};
...
var getElementStylesBySize = function getElementStylesBySize(
  props,
  type,
  field
) {
  ...
  return (
    variables[type] && variables[type][size] && variables[type][size][field]
  );
};
...
var getColor = function getColor(props, type) {
  var field =
    arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "base";
  ...
  return variables.colors[type][
    themeOverlay ? themeOverlay + (isSupreme ? "er" : "") : field
  ];
};
...
var _temp = (function () {
  ...
  __REACT_HOT_LOADER__.register(
    commonTheme,
    "commonTheme",
    "/Users/peymanghazvini/Desktop/filerobot-image-editor/projects/react/styledComponents/styleUtils.js"
  );
